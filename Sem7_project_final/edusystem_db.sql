...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Sep 25, 2025 at 10:31 PM
...
(3, 'Basics of Python Exam', 23, 2, 1, 1, 'Basics of Python', 'static/uploads\\python_questions.xlsx', 55, 15, '2025-09-30', '10:30:00', '12:00:00'),
(4, 'Basics of Python Exam', 23, 2, 1, 1, 'Basics of Python', 'static/uploads\\python_questions.xlsx', 55, 19, '2025-09-26', '10:00:00', '12:00:00');
...
(16, 2, 1, 4, 1, 'What is Python?', 'Python is a high-level, interpreted, object-oriented programming language known for its simplicity and readability.', 2),
(17, 2, 1, 4, 1, 'Differentiate between list and tuple in Python.', 'List: Mutable, defined with []. Tuple: Immutable, defined with ().', 3),
(18, 2, 1, 4, 1, 'Explain the concept of Python functions with an example.', 'A function is a block of reusable code. Example:\n```python\ndef add(a,b): return a+b\nprint(add(2,3))```', 5),
(19, 2, 1, 4, 1, 'What are Python decorators?', 'Decorators are functions that modify the behavior of other functions without changing their code. Example: @staticmethod.', 5),
(20, 2, 1, 4, 1, 'Explain exception handling in Python.', 'Exception handling is done using try, except, finally. Example:\n```python\ntry:\n x=1/0\nexcept ZeroDivisionError:\n print(\'Error!\')```', 5),
(21, 2, 1, 4, 1, 'What is Pandas in Python?', 'Pandas is a library for data analysis and manipulation providing DataFrame and Series objects.', 3),
(22, 2, 1, 4, 1, 'What is NumPy in Python?', 'NumPy is a library for numerical computing in Python. It provides N-dimensional array objects and mathematical functions.', 3),
(23, 2, 1, 4, 1, 'Explain the difference between shallow copy and deep copy.', 'Shallow Copy: Copies object references, changes affect original. Deep Copy: Creates new copy of objects, changes do not affect original.', 4),
(24, 2, 1, 4, 1, 'What are Python modules and packages?', 'Module: A single Python file. Package: A collection of modules in a directory with __init__.py.', 3),
(25, 2, 1, 4, 1, 'Explain the use of \'with\' statement in Python.', 'The \'with\' statement is used to simplify resource management (like file handling). Example:\n```python\nwith open(\'file.txt\',\'r\') as f:\n data=f.read()```', 4),
(26, 2, 1, 4, 1, 'What is the difference between is and == operator in Python?', 'is: checks identity (same memory). ==: checks equality of values.', 3),
(27, 2, 1, 4, 1, 'Explain Python\'s garbage collection mechanism.', 'Python uses automatic garbage collection with reference counting and a cyclic garbage collector.', 4),
(28, 2, 1, 4, 1, 'What is a generator in Python?', 'Generators are special functions that return an iterator using \'yield\'. They allow lazy evaluation.', 4),
(29, 2, 1, 4, 1, 'Explain global and local variables with example.', 'Local variables: declared inside a function, accessible only there. Global variables: declared outside, accessible everywhere.\n```python\nx=10\ndef f():\n global x\n x=20```', 4),
(30, 2, 1, 4, 1, 'What are Python lambda functions?', 'Lambda functions are anonymous one-line functions. Example: `f = lambda x: x+2; print(f(3))`.', 3);
