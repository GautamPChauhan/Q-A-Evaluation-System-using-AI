    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if user:
                ...
                # Teacher or Student login (hashed password check)
                    ...
                    if check_password_hash(stored_password, password):
                        ...
                        if user_role == 'teacher':
                            ...
                            required_fields = ['full_name', 'dob', 'last_degree', 'contact', 'gender', 
                        ...
                        flash(f"Welcome back, {user_role.capitalize()}!", "success")
